...
export class TraceRepository {
   ...
   */
  async findWorkflowsByTraceId(traceId: string): Promise<any[]> {
    try {
   ...
   */
  async findTasksByTraceId(traceId: string): Promise<any[]> {
    try {
   ...
   */
  private buildSpanList(workflows: any[], tasks: any[]): TraceSpan[] {
