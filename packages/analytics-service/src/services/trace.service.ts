...
export class TraceService {
  constructor(
    ...
    // workflowRepository is kept for future use in related queries
  ...
  private buildTree(spans: TraceSpan[]): TraceTreeNode[] {
    ...
    const sortChildren = (node: TraceTreeNode) => {
      node.children.sort((a, b) => a.span.created_at.getTime() - b.span.created_at.getTime())
    ...
    roots.sort((a, b) => a.span.created_at.getTime() - b.span.created_at.getTime())
